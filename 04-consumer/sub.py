    ...
    def executeDeployment(environment,client,product,trace_id):
      ...
      subprocess.run("helm repo add jpradoar https://jpradoar.github.io/helm-chart/", shell=True)
      
      sendmsg("  *[Consumer] [run]  Deployment for cliente: "+client + ", trace_id: " +trace_id)
